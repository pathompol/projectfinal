        ...
        <form action="update.php" method="post" enctype="multipart/form-data">
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              value="<?php echo $row['subject']?>" required>
            </div>
            ...
            <div class="form-group">
              ...
              <figure class="figure text-center d-block mt-2">
                  ...
                  <img id="imgUpload" src="../../../img/blog/<?php echo $row['image']; ?>" class="figure-img img-fluid rounded" alt="">
              </figure>
            </div>
            ...
            <div class="form-group">
              ...
              <select class="form-control select2" name="tags[]" multiple="multiple" data-placeholder="Select a Tags" style="width: 100%;">
                ...
                <option value="activity" <?php echo in_array('activity',$arrTag) ? 'selected' : ''; ?> >กิจกรรม</option>
                <option value="post"<?php echo in_array('post',$arrTag) ? 'selected' : ''; ?> >บทความ</option>
                <option value="news"<?php echo in_array('news',$arrTag) ? 'selected' : ''; ?> >ข่าวสาร</option>
              </select>
            </div>
